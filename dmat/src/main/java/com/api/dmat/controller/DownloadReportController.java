...
//	@GetMapping(value = "/downloadreport", produces = "application/json")
//	public ResponseEntity<?> sendReport() throws IOException, FileNotFoundException, ParseException { 		
//		
//		Long startTime;
...
//                    .header("Content_Disposotion", "attachment; filename="+file)
//                    .contentType(MediaType.MULTIPART_FORM_DATA)
//                    .body(file);
//			
////			return ResponseEntity.(HttpStatus.OK).body(new DownloadReportAPIResponseClass("Successfull Downloading",
